...
async function handleRequest(request, env) {
  ...
  const JWT_SECRET = new TextEncoder().encode(env.JWT_SECRET || "default_secret_replace_in_production");
...
// .wrangler/tmp/bundle-yayFdz/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-yayFdz/middleware-loader.entry.ts
